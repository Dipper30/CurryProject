...
class BaseException extends Error implements Exception {
  ...
  readonly config: ExceptionConfig = {
    ...
    [errCode.INVALID_DATE]: 'Invalid Date',
    [errCode.RECORD_ERROR]: 'Record Error',
    [errCode.INVALID_TAG]: 'Invalid Tag',
    [errCode.EXCEED_BOUND]: 'Exceed Bound',
    [errCode.NON_NEGATIVE]: 'Non Negative',
    [errCode.PARAMETER_ERROR]: 'Parameter Error',
  }
